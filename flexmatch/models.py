...
class WideResNet(nn.Module):
    """Wide ResNet model as used in FlexMatch paper"""
...
def wrn_28_2(num_classes=10):
    """Wide ResNet 28-2 (depth=28, widen_factor=2)"""
...
def wrn_40_2(num_classes=10):
    """Wide ResNet 40-2 (depth=40, widen_factor=2)"""
    return WideResNet(depth=40, num_classes=num_classes, widen_factor=2)

def wrn_40_10(num_classes=10):
    """Wide ResNet 40-10 (depth=40, widen_factor=10)"""
    return WideResNet(depth=40, num_classes=num_classes, widen_factor=10)

# Default model for CIFAR-10 (as used in FlexMatch paper)
def create_model(num_classes=10, model_name='wrn_28_2'):
    """
    ...
    if model_name not in model_dict:
        raise ValueError(f"Unknown model name: {model_name}. Available: {list(model_dict.keys())}")
